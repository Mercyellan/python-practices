Functions: 
funtions is a block of code that performs a single task.
...
Attributes: Variables that store data associated with the object.
...
the // sign (floor devision sign) devides a number and rounds up the answer to the nearest whole number 

the % sign (modulo sign)
it divides two number and only gives the remainder as the answer

the / sign (division sign) will always give an answer in a float data type 
